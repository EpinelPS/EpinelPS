...
public enum FieldOpenConditionType
{
    None = 0,
    SectorOpen = 1
}
public enum SurfaceFieldWaveSpawnType
{
    None = 0,
    InOrder = 1,
    Random = 2
...
public enum SurfaceTutorialSettingType
{
    None = 0,
    TeamPosition = 1,
    MonsterKill = 2,
...
public enum SurfaceFieldTileType
{
    None = 0,
    Terrain = 1,
    Blocking = 2,
...
public enum SurfaceFieldObjectType
{
    None = 0,
    Blocking = 1,
    Decoration = 2,
...
public enum SurfaceFieldThemeType
{
    None = 0,
    CityForest = 1
}
public enum SurfaceFieldEventComponent
{
    None = 0,
    BaseCamp = 1,
    MonsterSpawner = 2,
...
public enum SurfaceFieldToolEventGroup
{
    None = 0,
    SetContents = 1,
    SetWave = 2,
...
public enum SurfaceSuppressContentsType
{
    None = 0,
    BossRaid = 1,
    LegionRaid = 2,
...
public enum SurfacePlatoonSocketPoint
{
    None = 0,
    Top = 1,
    Head = 2,
...
public enum SurfaceKeepingTypeCondition
{
    On = 0,
    Off = 1
}
public enum SurfaceStatusTriggerStandardCondition
{
    None = 0,
    User = 1,
    User_platoon = 2,
...
public enum SurfaceStatusTriggerTypeCondition
{
    None = 0,
    IsARNumOver = 1,
    IsSMGNumOver = 2,
...
public enum SurfaceTimingTriggerStandardCondition
{
    None = 0,
    User = 1,
    User_platoon = 2,
...
public enum SurfaceTimingTriggerTypeCondition
{
    None = 0,
    OnAlways = 1,
    OnStart = 2,
...
public enum SurfaceDurationTypeCondition
{
    None = 0,
    Aura = 1,
    Battles = 2,
...
public enum SurfaceFunctionPreferTarget
{
    None = 0,
    Random = 1
}
public enum SurfaceTargetCategoryCondition
{
    None = 0,
    Character = 1,
    Nikke_character = 2,
    ...
    Monster_platoon = 6,
    Obstruction = 7,
    Optical_camouflage = 8
}
public enum SurfaceSkillRangeTypeCondition
{
    None = 0,
    All = 1,
    User = 2,
    User_platoon = 3,
    Current_attack_target = 4,
    Around = 5,
    Occupied_area = 6,
    Use_monster_use_area = 7,
    Around_calling_signal = 8,
    Around_not_self = 9,
    Battle_zone = 10
}
public enum SurfaceSkillValueTypeCondition
{
    Integer = 0,
    Percent = 1
}
public enum SurfaceSkillTypeCondition
{
    None = 0,
    SurfaceStatAtk = 1,
    SurfaceStatMaxHP = 2,
...
public enum SectorOpenConditionType
{
    None = 0,
...
public enum SurfaceResearchCostType
{
    None = 0,
    SurfaceItem = 1,
    SurfaceCurrency = 2
}
public enum SurfaceResearchFunctionValueType
{
    None = 0,
    Integer = 1,
    Percent = 2,
...
public enum SurfaceResearchFunctionType
{
    None = 0,
...
public enum ResearchOpenConditionType
{
    None = 0,
    SurfaceResearchLevel = 1,
    SurfaceBuildingLevel = 2
}
public enum SurfaceQuestType
{
    None = 0,
    Annihilation = 1,
    Collect = 2,
...
public enum SurfaceNarrativeSignActiveType
{
    None = 0,
    Auto = 1,
    Manual = 2
}
public enum SurfaceNarrativeSignType
{
    None = 0,
    Popup = 1,
    Balloon = 2
}
public enum SurfacePreferTarget
{
    Random = 0
}
...
public enum MonsterRangeCondition
{
    None = 0,
    Near = 1,
    Mid = 2,
...
public enum SurfaceMonsterRankType
{
    None = 0,
    Radial = 1,
    HighRank = 2
}
public enum SurfaceMonsterSkillValueType
{
    None = 0,
    Integer = 1,
    Percent = 2
}
public enum SurfaceMonsterFireType
{
    InstantArea = 0,
    InstantAreaNum = 1,
...
public enum SurfaceMonsterTrigger
{
    None = 0,
    HpRatioUnder = 1,
    CantAttack = 2
}
public enum SurfaceMonsterPreferTarget
{
    None = 0,
    Near = 1,
    Far = 2,
...
public enum SurfaceMonsterAction
{
    Skill = 0,
    SelfDestruct = 1
}
public enum SurfaceDialogThumbnailLocation
{
    None = 0,
    Left = 1,
    Right = 2
}
public enum SurfaceDialogOutputType
{
    None = 0,
    CameraAnimation = 1
}
public enum SurfaceMissionTutorialTriggerType
{
    None = 0,
    OnFieldBlocker = 1,
    OffFieldBlocker = 2,
...
public enum SurfaceMissionTriggerType
{
    Main = 0,
    Side = 1
}
public enum SurfaceMissionShortcutType
{
    None = 0,
...
public enum SurfaceMissionTrigger
{
    None = 0,
    GatewayOpen = 1,
    ResearchComplete = 2,
...
public enum SurfaceItemMaterialUseType
{
    None = 0,
...
public enum SurfaceItemConsumeUseType
{
    GetSurfaceCurrencyFixedValue = 0,
    Character_HP_Recovery_Per = 1,
    Character_Stamina_Recovery_Per = 2
}
public enum SurfaceItemType
{
    None = 0,
    OpticalCamouflage = 1,
...
public enum SurfaceGatewayType
{
    None = 0,
    GatewayTypeA = 1
}
public enum SurfaceForcedTriggerType
{
    None = 0,
...
public enum SurfaceTutorialSubGroup
{
    None = 0,
    Top = 1,
    Middle = 2,
...
public enum SurfaceTriggerHPType
{
    None = 0,
    Fixed = 1,
    Scaling = 2
}
public enum SurfaceWaveContentsClearType
{
    None = 0,
    Sweep = 1,
    Time = 2
}
public enum SurfaceWaveContentsType
{
    None = 0,
    Common = 1,
    Quest = 2,
...
public enum SurfaceFieldItemSpawnLogicType
{
    None = 0,
    Common = 1,
    Trigger = 2
}
public enum SurfaceFieldItemType
{
    None = 0,
    Item = 1,
    Memory = 2,
...
public enum SurfaceBossSpawnerType
{
    None = 0,
    Common = 1,
    Suppress = 2
...
public enum SurfaceFactoryPriceType
{
    None = 0,
    SurfaceCurrency = 1,
...
public enum SurfaceFactoryUnlockConditionType
{
    None = 0,
    SurfaceFactoryunlock_SectorOpen = 1
}
[MemoryPackable]
...
public enum SurfaceEvlaPurificationOpenConditionType
{
    None = 0,
    SurfaceSectorOpen = 1
}
public enum SurfaceWaveDifficultyType
{
    None = 0,
    Easy = 1,
    Normal = 2,
...
public enum SurfaceCategoryDataType
{
    Building = 0,
    Research = 1,
    Nikke = 2
}
public enum SurfaceCurrencyFunctionValueType
{
    None = 0,
    Integer = 1,
    Percent = 2
}
public enum SurfaceQuestRank
{
    None = 0,
    One = 1,
    Two = 2,
...
public enum SurfaceContentsLevelScalingType
{
    None = 0,
    Quest = 1,
    Suppress = 2
...
public enum SurfaceBuildingFunctionValueType
{
    None = 0,
    Integer = 1,
    Percent = 2,
...
public enum SurfaceBuildingFunctionType
{
    None = 0,
...
public enum SurfaceBuildCondition
{
    None = 0,
    Build = 1
}
...
public enum SurfaceBuffPartsPriceType
{
    None = 0,
    SurfaceCurrency = 1,
    SurfaceItem = 2
}
public enum SurfaceAutoChargeType
{
    None = 0,
    Daily = 1,
    Weekly = 2
...
public enum SurfaceAmbientSkillType
{
    None = 0,
    PartsBuff = 1,
    FieldBuff = 2,
...
public enum EventRebuildEdenUnitListConditionType
{
    None = 0,
    Quest = 1,
    Expedition = 2,
...
public enum EventRebuildEdenSynergyConditionType
{
...
public enum EventRebuildEdenRewardType
{
    EdenItems = 0,
    EdenUnits = 1
}
public enum EventRebuildEdenQuestType
{
    None = 0,
    FacilityConstruct = 1,
    FacilityEnhance = 2,
...
public enum EventRebuildEdenQuestCategory
{
    Main = 0,
    Task = 1,
    Sub = 2
}
public enum EventRebuildEdenMissionType
{
    FacilityConstruct = 0,
    FacilityEnhance = 1,
    MaterialCollect = 2,
...
public enum EventRebuildEdenMissionCategory
{
    Achievement = 0,
    Daily = 1
}
...
public enum EventRebuildEdenItemUnlockConditionType
{
    None = 0,
    Build = 1,
    MainQuest = 2,
...
public enum EventRebuildEdenItemCategory
{
    Material = 0,
    Equipment = 1,
    Etc = 2
}
public enum EventRebuildEdenEnvEventFxType
{
    Rain = 0,
    Storm = 1,
    Snow = 2,
...
public enum EventRebuildEdenEnvEventConditionType
{
    None = 0,
    Build = 1,
    MainQuest = 2
}
public enum EventRebuildEdenEffectApplyType
{
    None = 0,
    Build = 1,
    Barrack = 2,
...
public enum EventRebuildEdenListConditionType
{
    None = 0,
    Quest = 1,
    Dispatch = 2,
...
public enum EventRebuildEdenDispatchCategory
{
    Materials_Build = 0,
    Materials_Enhancement = 1,
    Materials_Special = 2
}
public enum EventRebuildEdenDialogPlayConditionType
{
    None = 0,
    ClearMainQuest = 1,
    CanClearMainQuest = 2,
...
public enum EventRebuildEdenDialogNamePlatePositionType
{
    None = 0,
    Left = 1,
    Right = 2
...
public enum EventRebuildEdenBuildSpecificType
{
    PowerPlant = 0,
    MaterialGenerator = 1,
    DailySupply = 2,
...
public enum EventRebuildEdenBuildUnlockConditionType
{
    None = 0,
    Build = 1,
    MainQuest = 2,
...
public enum EventRebuildEdenBuildCategory
{
    Electrics = 0,
    Production = 1,
    Force = 2,
...
public enum EventRebuildEdenEffectType
{
    None = 0,
