...
[GameRequest("/user/getwallpaperinventory")]
public class GetWallpaperInventory : LobbyMessage
{
    protected override async Task HandleAsync()
    {
        ...
        List<int> wallpaperIds = [.. GameData.Instance.LiveWallpaperTable.Where(w => w.Value.LivewallpaperType != Livewallpaper_type.SkillCutScene).Select(w => w.Key)];
